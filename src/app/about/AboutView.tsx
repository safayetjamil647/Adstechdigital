    ...
    <div className='dark:bg-dark min-h-screen bg-white'>
      ...
      <section className='dark:bg-dark-light bg-gray-50 py-24'>
        <div className='layout'>
          <div className='mx-auto max-w-3xl text-center'>
            <h1 className='h0 mb-8 leading-tight dark:text-white'>
        ...
        <div className='layout'>
          <div className='flex flex-col items-center gap-16 lg:flex-row'>
            <div className='w-full lg:w-1/2'>
              <h2 className='h1 mb-8 dark:text-white'>Our Story</h2>
            ...
            <div className='relative w-full lg:w-1/2'>
              <div className='bg-primary-100 dark:bg-primary-900/20 group aspect-square rotate-3 overflow-hidden rounded-3xl shadow-2xl'>
                <img
                  ...
                  alt='Ads Tech Digital Marketing Engineering Team'
      ...
      <section className='dark:bg-dark-light bg-gray-50 py-20'>
        <div className='layout'>
          <div className='mb-16 text-center'>
            <h2 className='h2 mb-4 dark:text-white'>Core Values</h2>
          ...
          <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4'>
            {values.map((value, index) => (
              ...
              >
                ...
                <h3 className='h3 mb-4 dark:text-white'>{value.title}</h3>
      ...
      <section className='py-24'>
        <div className='layout text-center'>
          <h2 className='h1 mb-8 dark:text-white'>Want to learn more about how we work?</h2>
