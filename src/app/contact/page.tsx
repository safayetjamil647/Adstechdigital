    ...
    <div className='dark:bg-dark min-h-screen bg-white'>
      ...
      <header className='dark:bg-dark-light bg-gray-50 py-24 text-center'>
        <div className='layout'>
          <h1 className='h0 font-primary mb-6 font-bold'>Get In Touch</h1>
        ...
        <div className='layout'>
          <div className='flex flex-col gap-16 lg:flex-row'>
            ...
            <div className='w-full space-y-12 lg:w-1/3'>
              <div>
                <h3 className='h3 mb-8'>Contact Information</h3>
                <div className='space-y-6'>
                  ...
                  {/* <div className="flex items-center gap-4 group">
                    <div className="w-12 h-12 rounded-2xl bg-primary-100 dark:bg-primary-900/20 text-primary-600 flex items-center justify-center shrink-0 transition-transform group-hover:scale-110">
                      <Phone className="w-6 h-6" />
                    </div>
                    <div>
                      <div className="text-sm text-gray-500 font-medium">Call us</div>
                      <div className="text-lg font-bold text-gray-900 dark:text-white">+1 (555) 123-4567</div>
                    </div>
                  </div> */}
                  ...
                  {/* <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      <div className="text-sm text-gray-500 font-medium">Visit our HQ</div>
                      <div className="text-lg font-bold text-gray-900 dark:text-white">New York, NY 10001</div>
                    </div>
                  </div> */}
                </div>
              </div>
