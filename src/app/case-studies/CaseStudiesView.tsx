    ...
    <div className='dark:bg-dark min-h-screen bg-white'>
      <header className='dark:bg-dark-light relative overflow-hidden bg-gray-50 py-24'>
        ...
        <div className='layout relative z-10 text-center'>
          ...
          <h1 className='h0 mb-6 dark:text-white'>Ads Case Studies</h1>
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              ...
              <div className='w-full lg:w-1/2'>
                ...
                <h2 className='h2 dark:text-white hover:text-primary-600 mb-6 cursor-pointer leading-tight transition-colors'>
                  {study.title}
                </h2>
      ...
      <section className='dark:bg-dark-light bg-gray-50 py-20'>
        <div className='layout text-center'>
          <h2 className='h2 mb-10 dark:text-white'>Ready to be our next success story?</h2>
